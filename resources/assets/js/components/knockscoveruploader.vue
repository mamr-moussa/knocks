...
>
    ...
    <div class="col s12 btn knocks_file_upload valign-wrapper " :id = "gid+`_container`" v-loading = "isLoading" >
      ...
      cropRes(){
        ...
        $($('body').find('#'+vm.gid+'_container')).addClass('bounceOut');
         ...
         vm.basic = new Croppie( document.getElementById('knocks_upload_port_'+vm.gid ), {
                  viewport: { width: 1230, height: 351 },
                  boundary: { width: 410, height: 117 },
                  showZoomer: true,
               ...
               //console.log(base64data);
                ...
                axios({
                  ...
                  if(temp == vm.success_at){
                     App.$emit('new_cover_uploaded' , {scope : vm.scope , blob : vm.result });
