...
<transition enter-active-class = "animated zoomIn" leave-active-class = "animated zoomOut">
	<div class = "row" v-if = "q1 == 'yes'">
		...
		<div class = "row">
			<span v-if = "q4[1] != 0 && q4[1] != 50" class = "knocks_text_dark_active">@{{q4[0]}} - @{{q4[1]}} Groups</span>
			<span v-if ="q4[1] == 0" class = "knocks_text_dark_active">None</span>
			<span v-if ="q4[1] == 50" class = "knocks_text_dark_active">More than 40 Groups</span>
			  <el-slider
		      v-model="q4"
		      range
		      show-stops
...
<transition enter-active-class = "animated zoomIn" leave-active-class = "animated zoomOut">
	<div class = "row" v-if = "q1 == 'yes'">
		...
		<div class = "row">
			<span v-if = "q8[1] != 0 && q8[1] != 14" class = "knocks_text_dark_active">@{{q8[0]}} - @{{q8[1]}} months</span>
			<span v-if ="q8[1] == 0" class = "knocks_text_dark_active">Less than a month</span>
			<span v-if ="q8[1] == 14" class = "knocks_text_dark_active">More than a year</span>
			  <el-slider
		      v-model="q8"
		      range
		      show-stops
